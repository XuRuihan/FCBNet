...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = SepConv(outplanes, feature_resolution=feature_resolution // stride)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = SepConv(
            ...
            stride=1 if use_aa else stride,  # no group, no dilation
        )
...
class ResNetFCB(BaseModule):
    ...
    def __init__(
        ...
        norm_layer = lambda x: build_norm_layer(norm_cfg, x)[1]
...
def _create_resnet(variant, pretrained=False, **kwargs):
    return build_model_with_cfg(ResNetFCB, variant, pretrained, **kwargs)
